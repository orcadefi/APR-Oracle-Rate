...
func main() {
	...
	for true {
		...
		fmt.Println("AREN")
		fmt.Println(instance.GetLendAaveAPR(nil,common.HexToAddress("0x408e41876cCCDC0F92210600ef50372656052a38")))
		fmt.Println(instance.GetBorrowAaveAPR(nil,common.HexToAddress("0x408e41876cCCDC0F92210600ef50372656052a38")))
		fmt.Println("AREP")
		...
		fmt.Println("IETHv1")
		fmt.Println(instance.GetLendFulcrumAPR(nil,common.HexToAddress("0x77f973FCaF871459aa58cd81881Ce453759281bC") ))
		fmt.Println(instance.GetBorrowFulcrumAPR(nil,common.HexToAddress("0x77f973FCaF871459aa58cd81881Ce453759281bC")))
		fmt.Println("IETH")
